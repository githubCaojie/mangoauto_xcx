            ...
            success: function (result) {
                ...
                if (result.success) {
                    ...
                    shops.forEach(function (objs, idx, arr) {
                      objs.CartItemModels.forEach(function(obj){
                        codeNum++
                        if (obj.IsCod == false){
                          falseCodeN++
                        }
                  ...
                  if (falseCodeN === codeNum) {
                    that.setData({
                      isCode: false
                    })
                  }
                  if (trueCodeN === codeNum) {
                   that.setData({
                      isCode: true
                    })
                  }
    ...
    submitOrder: function (e) {
        ...
        app.getOpenId(function (openid) {
            ...
            var parameters = {
                ...
                IsCashOnDelivery:that.data.IsCashOnDelivery,
                ...
                if (sd.success) {
                    if (that.data.isGroup) {
                        ...
                        if (!sd.data.RealTotalIsZero) {
                          ...
                          var IsCashOnDelivery = that.data.IsCashOnDelivery;
                            //普通支付
